...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h81177e79593a7208: (a: number, b: number) => void;
export const closure175_externref_shim: (a: number, b: number, c: any) => void;
